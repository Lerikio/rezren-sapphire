namespace :populate do
			...
			unless building == 'H' do
				...
				for story in 1..3
					for number in 1..13
						...
						current_room.save(false) # Evite les validations : normalement, une chambre devrait aussi avoir un port
					end
				end

				story = "0"
				unless building == 'B' do
					for number in 1..12
						if number < 10 do
							string_number = "0" + number.to_s
						else
	...
	task :ports => :environment, :switch_id, :nbr_of_ports do
	...
	task :switches => :environment, :nbr_of_switches, :nbr_of_ports do
