...
class ComputersControllerTest < ActionController::TestCase
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post :create, computer: { adherent_id: @computer.adherent_id, alias: @computer.alias, mac_address: @computer.mac_address }
    end
  ...
  test "should update computer" do
    put :update, id: @computer, computer: { adherent_id: @computer.adherent_id, alias: @computer.alias, mac_address: @computer.mac_address }
    assert_redirected_to computer_path(assigns(:computer))
  end
